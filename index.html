	...
	<body>
		...
		<!-- Header -->
			<section id="header">
				...
				<footer>
					<a href="#banner" class="button style2 scrolly-middle">Продолжить</a>
				</footer>
			</section>
		...
		<!-- Banner -->
			<section id="banner">
				...
				<p>Предлогаю вам посмотреть мой сайт<a href="http://VIP-CHITY.RU/"> @Мой сайт</a><br />
				В планах ещё один сайт "Program" мы работаем над ним@.<br />
				</p>
				<footer>
					<a href="#first" class="button style2 scrolly">Далее</a>
				</footer>
			</section>
		...
		<!-- Feature 1 -->
			<article id="first" class="container box style1 right">
				...
				<div class="inner">
					<header>
						<h2>Игровые картинки<br />
						WarFace</h2>
					</header>
					<p>WarFace - это многопользовательский шутер от первого лица с кучей лагов и фризов.</p>
				</div>
			</article>
		...
		<!-- Feature 2 -->
			<article class="container box style1 left">
				...
				<div class="inner">
					...
					<p>Devil May Cry 5 - Отличная игра от 3 лица с кучей спец эффектов.... Вообщем мне нравится ХD</p>
				</div>
			</article>
		...
		<!-- Portfolio -->
			<article class="container box style2">
				<header>
					...
					<p>Сдесь вы сможете посмотреть несколько картинок из игр<br />
					[Картинки ещё не загружены!]</p>
				</header>
		...
		<section id="footer">
			<ul class="icons">
				<li><a href="https://twitter.com/Mod_CLEAT" class="icon fa-twitter"><span class="label">Twitter</span></a></li>
				<li><a href="https://www.facebook.com/profile.php?id=100007588607785" class="icon fa-facebook"><span class="label">Facebook</span></a></li>
				<li><a href="https://plus.google.com/u/0/115373994734889301990" class="icon fa-google-plus"><span class="label">Google+</span></a></li>
			</ul>
			<div class="copyright">
				<ul class="menu">
					<li>&copy; Untitled. All rights reserved.</li><li>Design: <a href="https://vk.com/alexander_kovalyov99">HAN</a></li>
				</ul>
			</div>
		</section>
